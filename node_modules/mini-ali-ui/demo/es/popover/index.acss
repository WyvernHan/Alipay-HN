...
.am-popover-mask {
  ...
  background-color: var(--am-popover-mask-color, rgba(0, 0, 0, 0.5));
  height: 100%;
  z-index: 99;
}
.am-popover-content {
  ...
  z-index: 100;
  border-radius: 4px;
  border-radius: var(--am-popover-border-radius, 4px);
  font-size: 15px;
  font-size: var(--am-popover-font-size, 15px);
  color: #333;
  color: var(--am-popover-font-color, #333);
}
.border-true {
...
.am-popover-inner {
  ...
  background-color: var(--am-popover-bg-color, #fff);
  border-radius: 4px;
  border-radius: var(--am-popover-border-radius, 4px);
  overflow: hidden;
}
...
.am-popover-arrow {
  ...
  height: 7px;
  background-color: #fff;
  background-color: var(--am-popover-arrow-color, #fff);
  z-index: 0;
